...
(function (e, t, i) {
    function n(e, t) {
        ...
        var o = {
            method: "GET",
            timeout: 15e3
        }, l = t._exec, u = "GroupRuleExecution" === l.type ? l.element.domElem : t.field, h = e.success, c = e.error, d = l.element.options, p = JSON ? JSON.stringify(e) : a(), m = {
            success: h,
            error: c || n
        };
        if (s.loaded[p]) {
            var g = s.loaded[p], v = m.success;
            return v.apply(t, g), i
        }
        if (s.loading[p] || (s.loading[p] = []), s.loading[p].push(m), 1 === s.loading[p].length) {
            d.prompt(u, "Checking...", "load");
            var y = {success: r, error: r};
    ...
    (function (e, t, i) {
        ...
        b = "notify", y = b + "js", x = {
        ...
        }, E = {"border-radius": ["-webkit-", "-moz-"]}, u = function (e) {
            return F[e]
        }, r = function (t, n) {
            var r, s;
            ...
            var i;
            return i = function () {
            }, i.prototype = e, $.extend(!0, new i, t)
        }, o = function (e) {
            return $.extend(A, e)
        }, a = function (e) {
            return $("<" + e + "></" + e + ">")
            ...
            function e(e, t, i) {
                "string" == typeof i && (i = {className: i}), this.options = f(A, $.isPlainObject(i) ? i : {}), this.loadHTML(), this.wrapper = $(s.html), this.wrapper.data(y, this), this.arrow = this.wrapper.find("." + y + "-arrow"), this.container = this.wrapper.find("." + y + "-container"), this.container.append(this.userContainer), e && e.length && (this.elementType = e.attr("type"), this.originalElement = e, this.elem = l(e), this.elem.data(y, this), this.elem.before(this.wrapper)), this.container.hide(), this.run(t)
            }
            ...
            return e.prototype.loadHTML = function () {
                ...
                if (r = function () {
                    ...
                    }, o = this.container.parent().parents(":hidden").length > 0, s = this.container.add(this.arrow), n = [], o && e)a = "show"; else if (o && !e)a = "hide"; else if (!o && e)a = this.options.showAnimation, n.push(this.options.showDuration); else {
                    if (o || e)return r();
        ...
        }, $.extend($[b], {defaults: o, addStyle: r, pluginOptions: A, getStyle: u, insertCSS: p}), $(function () {
        ...
        e.console === i && (e.console = {isFake: !0});
    ...
    var s = {loading: {}, loaded: {}}, a = function () {
        return a.curr++
    };
    a.curr = 1, $.fn.verifyScrollView = function (e) {
        ...
        var n = $.extend({scrollTarget: e, offsetTop: 50, duration: 500, easing: "swing"}, t);
        return this.each(function () {
            var e = $(this), t = "number" == typeof n.scrollTarget ? n.scrollTarget : $(n.scrollTarget), r = "number" == typeof t ? t : t.offset().top + e.scrollTop() - parseInt(n.offsetTop, 10);
            e.animate({scrollTop: r}, parseInt(n.duration, 10), n.easing, function () {
                "function" == typeof i && i.call(this)
            })
        })
    }, $.fn.equals = function (e) {
        if ($(this).length !== e.length)return !1;
        for (var t = 0, i = $(this).length; i > t; ++t)if ($(this)[t] !== e[t])return !1;
        return !0
    };
    var o = null;
    (function () {
    ...
    var l = o.extend({
        init: function (e, t) {
            ...
            for (var t = 0, i = this.array.length; i > t; ++t)if ($.isFunction(e) ? e(this.get(t)) : this.equals(this.get(t), e))return t;
            return -1
        }, find: function (e) {
            ...
            for (var t = 0, i = this.array.length; i > t; ++t)if (e(this.get(t)) === !1)return
        }, map: function (e) {
        ...
        create: function (e) {
        ...
        }, bind: $.proxy, checkOptions: function (e) {
            if (e)for (var t in e)g[t] === i && p("Invalid option: '" + t + "'")
            ...
            var i = $(t), n = $("body"), r = e && e.hasClass("rtl") || e && "rtl" === (e.attr("dir") || "").toLowerCase() || i.hasClass("rtl") || "rtl" === (i.attr("dir") || "").toLowerCase() || n.hasClass("rtl") || "rtl" === (n.attr("dir") || "").toLowerCase();
            return Boolean(r)
        }
    }, c = "0.0.1", d = $.consoleNoConflict({prefix: "verify.js: "}), f = d.log, p = d.warn, m = d.info, g = {
        debug: !1,
        autoInit: !0,
        ...
        prompt: function (e, t, i) {
            "function" === $.type($.notify) && (i || (i = {color: "red"}), $.notify(e, t, i))
        }
    };
    r.prototype = g;
    var v = o.extend({
        name: "Class", toString: function () {
        ...
        init: function (e, t) {
            ...
            if ($.isFunction(this.userObj.fn))this.fn = this.userObj.fn; else {
            ...
            var t = [];
            return t.push({}), t.push(this.userObj), t.push(this.defaultInterface), "field" === this.type && (t.push(this.defaultFieldInterface), t.push({field: e.element.domElem})), "group" === this.type && t.push(this.defaultGroupInterface), t.push({
    ...
    (function () {
        var e = function (e) {
        ...
        }, t = h.memoize(e), n = {}, r = {}, s = function (e, t) {
            for (var i in t)n[i] && p("validator '%s' already exists", i), $.isFunction(t[i]) && (t[i] = {fn: t[i]}), t[i].__ruleType = e;
            $.extend(!0, n, t)
        }, a = function (e) {
            s("field", e)
        }, o = function (e) {
            ...
            var i = e.form.options.validateAttribute, n = e.domElem.attr(i);
            return n ? t(n) : null
        }, d = function (e) {
            var t = !1, i = null, n = [];
    ...
    (function () {
        var e = v.extend({
            type: "ValidationElement", init: function (e) {
            ...
            type: "ValidationField", init: function (e, t) {
                ...
                var t = this.options, i = t.reskinContainer(this.domElem);
        ...
        A = e.extend({
            type: "ValidationForm", init: function (e, s) {
                ...
                var t = $(e.currentTarget), i = t.data("verify") || this.updateField(t);
    ...
    (function () {
        var e = {NOT_STARTED: 0, RUNNING: 1, COMPLETE: 2}, t = v.extend({
            type: "Execution", init: function (t, i) {
                ...
                var n = this.mapExecutables(e), r = this, s = 0, a = 0, o = n.length, l = !1;
        ...
        x = t.extend({
            type: "FormExecution", init: function (e) {
            ...
            type: "FieldExecution", init: function (e, t) {
                ...
                this._super();
                var e, t = this, i = this.children;
                for (e = 0; i.length > e; ++e)if (i[e].success === !1) {
                    t = i[e];
                    break
                }
        ...
        var n = t.extend({
            type: "RuleExecution", init: function (e, t) {
            ...
            type: "GroupRuleExecution", init: function (e, t) {
                ...
                var t, n, r, s = this.group.exec, a = this.parent, o = a && a.parent, l = !o, u = o instanceof x, h = !1;
                ...
                } else this.log("MASTER"), this.members = [this], this.executeGroup = this._super, s = this.group.exec = this, u && s.linkFail(o);
                if (l)for (t = 0; this.group.size() > t; ++t)if (n = this.group.get(t), this.element !== n) {
                ...
                var c = this.group.size(), d = s.members.length;
                ...
                var t = $.isPlainObject(e), i = "string" == typeof e;
        ...
        return t.verify === i ? (e.alert("Please include verify.js before each rule file"), i) : (t.verify.addFieldRules({
            ...
            url: {regex: /^https?:\/\/[\-A-Za-z0-9+&@#\/%?=~_|!:,.;]*[\-A-Za-z0-9+&@#\/%=~_|]/, message: "Invalid URL"},
            alphanumeric: {regex: /^[0-9A-Za-z]+$/, message: "Use digits and letters only"},
            street_number: {regex: /^\d+[A-Za-z]?(-\d+)?[A-Za-z]?$/, message: "Street Number only"},
            number: {regex: /^\d+$/, message: "Use digits only"},
            numberSpace: {regex: /^[\d\ ]+$/, message: "Use digits and spaces only"},
            postcode: {regex: /^\d{4}$/, message: "Invalid postcode"},
            date: {
                fn: function (e) {
            ...
            required: {
                ...
                requiredField: function (e, i) {
                    ...
                    switch (i.prop("type")) {
                        case"radio":
                        case"checkbox":
                            var r = i.attr("name"), s = i.data("fieldGroup");
            ...
            size: function (e) {
                var t = e.val(), n = e.args[0], r = e.args[1];
                if (n !== i && r === i) {
                    var s = parseInt(n, 10);
            ...
            min: function (e) {
                var t = e.val(), i = parseInt(e.args[0], 10);
            ...
            decimal: function (e) {
                var t = e.val(), i = e.args[0] ? parseInt(e.args[0], 10) : 2;
                if (!t.match(/^\d+(,\d{3})*(\.\d+)?$/))return "Invalid decimal value";
                var n = parseFloat(t.replace(/[^\d\.]/g, "")), r = Math.pow(10, i);
                return n = Math.round(n * r) / r, e.field.val(n), !0
            },
            minVal: function (e) {
                var t = parseFloat(e.val().replace(/[^\d\.]/g, "")), i = e.args[1] || "", n = parseFloat(e.args[0]);
            ...
            rangeVal: function (e) {
                var t = parseFloat(e.val().replace(/[^\d\.]/g, "")), i = e.args[2] || "", n = e.args[3] || "", r = parseFloat(e.args[0]), s = parseFloat(e.args[1]);
            ...
            dateRange: function (e) {
                var i = e.field("start"), n = e.field("end");
                ...
                extend: "required", fn: function (e) {
                    var i, n = (e.fields().length, []), r = [];
                    return e.fields().each(function (t, s) {
                        i = e.requiredField(e, s), i === !0 ? n.push(s) : r.push({field: s, message: i})
